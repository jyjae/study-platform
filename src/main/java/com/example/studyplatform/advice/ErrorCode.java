...
public enum ErrorCode {
    ...
    PROJECT_ORGANIZATION_DECREASE_ZERO(-1005, "프로젝트 모집 인원이 0이하 입니다."),
    PROJECT_POST_NOT_FOUND(-1006, "해당 프로젝트 게시글은 존재하지 않습니다."),
    PROJECT_ORGANIZATION_NOT_FOUND(-1007, "해당 프로젝트 인원은 존재하지 않습니다.");
